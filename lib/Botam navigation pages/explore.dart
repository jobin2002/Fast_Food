...
class Explorepage extends StatefulWidget {
  ...
  @override
  State<Explorepage> createState() => _UploadImageAndMoreState();
}

class _UploadImageAndMoreState extends State<Explorepage> {
  String imageUrl = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Get Your Meals With Big Offers"),
        backgroundColor: Colors.black,
      ),
