...
class Categorypizza extends StatefulWidget {
  const Categorypizza({super.key});

  @override
  State<Categorypizza> createState() => _UploadImageAndMoreState();
}

class _UploadImageAndMoreState extends State<Categorypizza> {
  ...
  void initState() {
    super.initState();
    _stream = FirebaseFirestore.instance.collection('Pizza').snapshots();
  }
