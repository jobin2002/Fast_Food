...
class Categoryburger extends StatefulWidget {
  const Categoryburger({super.key});

  @override
  State<Categoryburger> createState() => _UploadImageAndMoreState();
}

class _UploadImageAndMoreState extends State<Categoryburger> {
  ...
  void initState() {
    super.initState();
    _stream = FirebaseFirestore.instance.collection('Burger').snapshots();
  }
