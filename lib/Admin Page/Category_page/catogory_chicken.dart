...
class Categorychicken extends StatefulWidget {
  const Categorychicken({super.key});

  @override
  State<Categorychicken> createState() => _UploadImageAndMoreState();
}

class _UploadImageAndMoreState extends State<Categorychicken> {
  ...
  void initState() {
    super.initState();
    _stream = FirebaseFirestore.instance.collection('Chicken').snapshots();
  }
