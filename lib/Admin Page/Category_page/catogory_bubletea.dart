...
class Categorybubletea extends StatefulWidget {
  const Categorybubletea({super.key});

  @override
  State<Categorybubletea> createState() => _UploadImageAndMoreState();
}

class _UploadImageAndMoreState extends State<Categorybubletea> {
  final TextEditingController _nameController = TextEditingController();
  final TextEditingController _numberController = TextEditingController();
  final TextEditingController _descriptionController = TextEditingController();

  final CollectionReference _items =
      FirebaseFirestore.instance.collection("Bubble_tea");
  ...
  void initState() {
    super.initState();
    _stream = FirebaseFirestore.instance.collection('Bubble_tea').snapshots();
  }
