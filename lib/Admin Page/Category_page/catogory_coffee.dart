...
class Categorycoffe extends StatefulWidget {
  const Categorycoffe({super.key});

  @override
  State<Categorycoffe> createState() => _UploadImageAndMoreState();
}

class _UploadImageAndMoreState extends State<Categorycoffe> {
  ...
  void initState() {
    super.initState();
    _stream = FirebaseFirestore.instance.collection('Coffee').snapshots();
  }
