...
class Categoryvegitable extends StatefulWidget {
  const Categoryvegitable({super.key});

  @override
  State<Categoryvegitable> createState() => _UploadImageAndMoreState();
}

class _UploadImageAndMoreState extends State<Categoryvegitable> {
  ...
  void initState() {
    super.initState();
    _stream = FirebaseFirestore.instance.collection('Vegetable').snapshots();
  }
